 ...
 */
public class QualFragment extends Fragment implements OnPageChangeListener, OnLoadCompleteListener,
        OnPageErrorListener {

    private static final String ARG_SECTION_NUMBER = "section_number";
    private static final String FILE_NAME = "score_qual_standards.pdf";
    private PDFView pdfView;

    public static QualFragment newInstance(int index) {
        QualFragment fragment = new QualFragment();
